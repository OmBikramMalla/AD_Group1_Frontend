/* Route Configuration — Features 2, 3, 4, 15 & 16: Admin Staff, Parts,
   Purchase Invoices, Notifications & Loyalty discount (in Sales Invoice) */
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          {/* Staff — Feature 16: Loyalty 10% discount (spend > 5000)
                       implemented inside the Sales Invoice page */}
